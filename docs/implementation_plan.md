...
- [ ] 트윗 작성 기능
  ...
  - 데이터베이스에 저장
  - 성공 후 피드 새로고침
  - 트윗 작성 성공/실패 시 Toast 알림 표시
  - **확인 방법**:
    - 트윗 작성 폼에서 내용 입력 후 게시 버튼 클릭
    - 유효하지 않은 입력(너무 긴 텍스트 등) 시 에러 메시지가 표시되는지 확인
    - 트윗 작성 성공 시 Toast 성공 메시지가 표시되는지 확인
    - 트윗 작성 실패 시 Toast 에러 메시지가 표시되는지 확인
...
- [ ] 트윗 삭제 기능
  ...
  - 트윗 삭제 성공/실패 시 Toast 알림 표시
  - **확인 방법**:
    - 본인이 작성한 트윗에만 삭제 버튼이 표시되는지 확인
    - 다른 사용자의 트윗에는 삭제 버튼이 표시되지 않는지 확인
    - 삭제 버튼 클릭 시 삭제 확인 다이얼로그가 표시되는지 확인
    - 삭제 확인 후 트윗 삭제 성공 시 Toast 성공 메시지가 표시되는지 확인
    - 삭제 실패 시 Toast 에러 메시지가 표시되는지 확인
