...
- [ ] 고급 북마크 기능 (확장)
  ...
  - [ ] 북마크 폴더/카테고리 (컬렉션)
    ...
    - 폴더별 북마크 조회 뷰
  - **확인 방법**:
    - 북마크 페이지 상단 검색바에서 검색 시 필터링된 결과가 나오는지 확인
    - '미디어만 보기' 필터 적용 시 사진/영상이 있는 트윗만 표시되는지 확인
    - 새 폴더를 생성하고 트윗을 해당 폴더에 저장할 수 있는지 확인
    - 폴더 탭 이동 시 해당 폴더의 트윗만 표시되는지 확인
