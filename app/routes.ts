...
export default [
    ...
    // API Routes - Auth
    route("api/auth/*", "routes/auth/api.auth.ts", { id: "api-auth" }),
    route("auth/google/callback", "routes/auth/api.auth.ts", { id: "google-callback" }),
    route("auth/kakao/callback", "routes/auth/api.auth.ts", { id: "kakao-callback" }),
